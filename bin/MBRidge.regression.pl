...
#use Math::Trig;
#############################################
my ($test,$out,$s,$model,$name,$alpha,$p,$handle,$win_max,$outdir,$Help);
GetOptions
(
	"t=s" => \$test,
	"out=s" => \$outdir,
...
names(data)<-c(\"chr\",\"pos\",\"strand\",\"RRBSmethy\",\"RRBSdepth\",\"RRBSrate\",\"MBmethy\",\"MBdepth\",\"MBrate\",\"backmethyRate\",\"backmethygroup\",\"CGdensity\",\"GCcoutent\",\"CGoe\")
data1=data[data[,9]>0,]
data2=data[data[,9]==0,]
n<-nrow(data1)
...
dataXTrain<-dataTrain[,c(7,8,9,10,11,12,13,14)]
dataXTest<-dataTest[,c(7,8,9,10,11,12,13,14)]
...
print(paste(\"Pearson correlation between RRBS and MBRidge is\",pearsoncor,sep=\" \"))
##test...
datatest<-read.table(\"$test\")
data=data[data[,9]>0,]
datatest=datatest[datatest[,9]>0,]
names(data)<-c(\"chr\",\"pos\",\"strand\",\"RRBSmethy\",\"RRBSdepth\",\"RRBSrate\",\"MBmethy\",\"MBdepth\",\"MBrate\",\"backmethyRate\",\"backmethygroup\",\"CGdensity\",\"GCcoutent\",\"CGoe\")
names(datatest)<-c(\"chr\",\"pos\",\"strand\",\"RRBSmethy\",\"RRBSdepth\",\"RRBSrate\",\"MBmethy\",\"MBdepth\",\"MBrate\",\"backmethyRate\",\"backmethygroup\",\"CGdensity\",\"GCcoutent\",\"CGoe\")
dataTrain<-data
dataTest<-datatest
toff<-dataTrain\$RRBSrate
dataXTrain<-dataTrain[,c(7,8,9,10,11,12,13,14)]
