...
my $fh;
##############################################
print STDOUT "#chr\tposition\tstrand\tRRBS-methy\tRRBS-depth\tRRBS-rate\tMB-methy\tMB-depth\tMB-rate\tMB_backMethyRate\tMB_backMethyGroup\tCGdensity\tGCcontent\tCGoe\tType\tMBRidge-value\n";
foreach my $file (@files){
        $fh=open_file($file);
        while(<$fh>){
                chomp;
