...
dataXTrain<-dataTrain[,c(9,10,11,12,13,14,15,16)]
dataXTest<-dataTest[,c(9,10,11,12,13,14,15,16)]
...
print(paste(\"Pearson correlation coefficient between RRBS and MBRidge is\",pearsoncor,sep=\" \"))
##test...
